...
export const en: Record<FetchCardLocaleKey, string> = {
  ...
  proxy: 'Local proxy',
  proxyHint: 'Optional HTTP proxy, e.g. http://127.0.0.1:13004, for networks that block the service. Applies per request to every provider; leave blank for direct.',
  proxyEnable: 'Enable',
...
export const zh: Record<FetchCardLocaleKey, string> = {
  ...
  proxy: '本地代理',
  proxyHint: '可选 HTTP 代理，如 http://127.0.0.1:13004，用于网络被阻断的服务。对所有服务商生效，按请求代理；留空走直连。',
  proxyEnable: '启用',
